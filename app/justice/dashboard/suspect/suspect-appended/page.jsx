...
const SuspectAppended = ({ isOpen, onClose }) => {
  if (!isOpen) return null;

  return (
    <div className="appended">
      <div className="appended__overlay" onClick={onClose}></div>
      <div className="retrieve-notif">
        ...
        <div>Suspect Profile #3 Appended</div>
      </div>
    </div>
  );
};

export default SuspectAppended;
